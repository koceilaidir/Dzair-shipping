              ...
              Flexible(
                child: lignes.isEmpty
                    ...
                    : ListView(shrinkWrap: true, children: [
                        for (final l in lignes) _row(l, ctrls[l['id']]!, libre[l['id']]!, reserve[l['id']] ?? 0,
                            reservePar[l['id']], sugg[l['id']] ?? 0, prixKiloMin, () => setSt(() {})),
                      ]),
              ),
              const SizedBox(height: 12),
              Row(children: [
                ...
                FilledButton(
                  onPressed: (saving || depasse || kgChoisi <= 0) ? null : save,
                  child: saving
                      ? const SizedBox(height: 18, width: 18, child: CircularProgressIndicator(strokeWidth: 2))
                      : Text(depasse ? 'Trop de kilos' : 'Mettre dans la valise'),
                ),
              ]),
            ]),
          ),
...
Widget _row(Map l, TextEditingController c, double libre, double reserve, String? par,
    double sugg, double pkMin, VoidCallback onChange) {
  ...
  return Container(
    ...
    child: Row(children: [
      Expanded(flex: 5, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        // Origine + prix + manque : un même produit peut venir de plusieurs chambres
        // avec des conditions différentes — on ne confond jamais les lots.
